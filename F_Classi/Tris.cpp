/*
se in griglia c'é ZERO cella vuota
se in griglia c'é UNO stiamo parlando di una X (giocatore 1)
se in griglia c'é DUE stiamo parlando di un cerchio (giocatore 2)
*/
